...
class App extends Component {
    ...
    //Handle LogOut,Set currentUser and is Authenticated state which be passed to other components
    handleLogout(redirectTo = "/", notificationType = "success", description = "成功登出") {
